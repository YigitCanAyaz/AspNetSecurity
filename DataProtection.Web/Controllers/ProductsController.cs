...
namespace DataProtection.Web.Controllers
{
    ...
    {
        private readonly AspNetSecurityContext _context;
        private readonly IDataProtector _dataProtector;

        public ProductsController(AspNetSecurityContext context, IDataProtectionProvider dataProtectionProvider)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var timeLimitedProtector = _dataProtector.ToTimeLimitedDataProtector(); // returns ITimeLimitedDataProtector
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AspNetSecurityContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
